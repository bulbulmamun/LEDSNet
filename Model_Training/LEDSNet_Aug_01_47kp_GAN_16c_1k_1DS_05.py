#######################################################################################
## LEDSNet Arrhythmia classifier  full script with GAN-based augmentation
#######################################################################################
...
class CombinedModel(nn.Module):
    def __init__(self, num_classes=16):
        ...
        # SqueezeNet stages
        self.stages['Stage 5'] = FireModule(16, 32, 16, 16)  
        self.stages['Stage 6'] = FireModule(32, 64, 8, 8)  

        # Final layers
        self.stages['Stage 7'] = nn.AdaptiveAvgPool1d(1)
        self.stages['Stage 8'] = nn.Flatten()
        self.stages['Stage 9'] = nn.Linear(16, num_classes)
...
# -----------------------------------------------------------------------------#
#   Stop CodeCarbon & print footprint                                       #
# -----------------------------------------------------------------------------#
